...
public class DoWhileP3Q3Dialog {
	...
	public static void main(String[] args) {
        ...
        do {
        	JOptionPane.showMessageDialog(null,"Informe o número do canal e o total de pessoas assistindo (digite 0 para encerrar): ");
            ...
            if (canal != 0) {
                ...
                int numPessoas = Integer.parseInt(entrada);
                ...
                switch (canal) {
                    ...
                    case 12:
                        ...
                        break;
                    default:
                        JOptionPane.showMessageDialog(null, "Canal inválido. Informe um dos canais válidos.");
                        break;
                }
